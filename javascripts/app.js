...
function downloadResource(){
	...
	imgBullet1.src = 'images/bullet1.png';
	imgBullet1.onload=function(){
		progress+=3;
		drawProgress();
	}

	imgsEnemy1[0].src = 'images/enemy1.png';
	imgsEnemy1[0].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy1[1].src = 'images/enemy2_down1.png';
	imgsEnemy1[1].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy1[2].src = 'images/enemy1_down2.png';
	imgsEnemy1[2].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy1[3].src = 'images/enemy1_down3.png';
	imgsEnemy1[3].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy1[4].src = 'images/enemy1_down4.png';
	imgsEnemy1[4].onload=function(){
		progress+=3;
		drawProgress();
	}

	imgsEnemy2[0].src = 'images/enemy2.png';
	imgsEnemy2[0].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy2[1].src = 'images/enemy2_down1.png';
	imgsEnemy2[1].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy2[2].src = 'images/enemy2_down2.png';
	imgsEnemy2[2].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy2[3].src = 'images/enemy2_down3.png';
	imgsEnemy2[3].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy2[4].src = 'images/enemy2_down4.png';
	imgsEnemy2[4].onload=function(){
		progress+=3;
		drawProgress();
	}

	imgsEnemy3[0].src = 'images/enemy3_n1.png';
	imgsEnemy3[0].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[1].src = 'images/enemy3_n2.png';
	imgsEnemy3[1].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[2].src = 'images/enemy3_hit.png';
	imgsEnemy3[2].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[3].src = 'images/enemy3_down1.png';
	imgsEnemy3[3].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[4].src = 'images/enemy3_down2.png';
	imgsEnemy3[4].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[5].src = 'images/enemy3_down3.png';
	imgsEnemy3[5].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[6].src = 'images/enemy3_down4.png';
	imgsEnemy3[6].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[7].src = 'images/enemy3_down5.png';
	imgsEnemy3[7].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsEnemy3[8].src = 'images/enemy3_down6.png';
	imgsEnemy3[8].onload=function(){
		progress+=3;
		drawProgress();
	}

	imgsGameLoading[0].src = 'images/game_loading1.png';
	imgsGameLoading[0].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsGameLoading[1].src = 'images/game_loading2.png';
	imgsGameLoading[1].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsGameLoading[2].src = 'images/game_loading3.png';
	imgsGameLoading[2].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsGameLoading[3].src = 'images/game_loading4.png';
	imgsGameLoading[3].onload=function(){
		progress+=3;
		drawProgress();
	}

	imgGamePause.src = 'images/game_pause_nor.png';
	imgGamePause.onload=function(){
		progress+=3;
		drawProgress();
	}

	imgsHero[0].src = 'images/hero1.png';
	imgsHero[0].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsHero[1].src = 'images/hero2.png';
	imgsHero[1].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsHero[2].src = 'images/hero_blowup_n1.png';
	imgsHero[2].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsHero[3].src = 'images/hero_blowup_n2.png';
	imgsHero[3].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsHero[4].src = 'images/hero_blowup_n3.png';
	imgsHero[4].onload=function(){
		progress+=3;
		drawProgress();
	}
	imgsHero[5].src = 'images/hero_blowup_n4.png';
